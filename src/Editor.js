...
align="center">
  ...
  {!isVoiceStarted ? (
    ...
    <VStack align="start" spacing={3}>
      <Tag size="lg" colorScheme="green">✅ Voice is Active</Tag>
      <HStack>
        <Button onClick={handleMute} colorScheme="yellow">
          {isMuted ? 'Unmute' : 'Mute'}
        </Button>
        <Button onClick={handleStop} colorScheme="red">End Voice</Button>
      </HStack>
    </VStack>
  )}
</TabPanel>
